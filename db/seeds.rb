...
# a1 user is Alicia
a1 = Adventure.create(title: 'Hiking', photo: 'https://xdaysiny.com/wp-content/uploads/2017/07/Hiking-Diamond-Head-Honolulu-Oahu-Hawaii.jpg', location: 'Hawaii', hashtags: '#nature', description: "The scenery is so beautiful, I'm deathly afraid of heights though. Yikes.", likes: 0) 

#a2 user is Liam
a2 = Adventure.create(title: 'Skydiving', photo: 'https://www.skydive.com.mx/images/gallery/4.jpg', location: 'Mexico', hashtags: '#hardcore', description: "Skydiving in Playa Del Carmen was crazy. I even tried a little stunt.", likes: 0) 

# a3 user is Rachel
a3 = Adventure.create(title: 'Whitewater Rafting', photo: 'https://i.pinimg.com/originals/c7/34/b1/c734b166cd924a8122915ae5599b7af4.jpg', location: 'Australia', hashtags: '#rafting', description: "What a rush!", likes: 0) 
